...
public class AbortPolicy {
     ...
     * handler first by AbortPolicy class which will propagate the exeption to
    ...
    public static void main(final String... args) {
        ...
        final ExecutorService es = new ThreadPoolExecutor(1, 1, 120, TimeUnit.SECONDS, new ArrayBlockingQueue<>(1), new ThreadPoolExecutor.AbortPolicy());
